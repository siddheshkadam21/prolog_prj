/*This is the data set, here edge is the predicate and a,b,c,d,h are the nodes with cost assign to them. */
...
/* Finding the Best pathor we can the  shortest_path.*/
...
/*here we are  adding  the stopping location to the visited list, adding  the distance and then calls recursive
